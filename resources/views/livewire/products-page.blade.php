                    ...
                    <div class="w-full pr-2 lg:w-1/4 lg:block">
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
                            ...
                            <ul>
                                ...
                                <li class="mb-4" wire:key="{{$ctg->id}}">
                                    <label for="{{$ctg->slug}}" class="flex items-center dark:text-gray-400 ">
                                        <input type="checkbox" id="{{$ctg->slug}}" wire:model.live="select_categories" value="{{$ctg->id}}" class="w-4 h-4 mr-2">
                                        <span class="text-lg">{{$ctg->name}}</span>
                                    </label>
                                </li>
                                @endforeach
                            </ul>
                            ...
                            <ul>
                                ...
                                <li class="mb-4" wire:key="{{$brand->id}}">
                                    <label for="{{$brand->slug}}" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" id="{{$brand->slug}}" wire:model.live="select_brand" value="{{$brand->id}}" class="w-4 h-4 mr-2">
